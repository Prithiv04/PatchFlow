...
from app.utils.ffmpeg_utils import extract_video_metadata, generate_thumbnail
...
class ProcessingService:
    ...
    async def process_video(video_id: str) -> VideoProcessingResponse:
        ...
        # 3. Calculate thumbnail timestamp
        ...
        # 4. Execute FFmpeg thumbnail generation
        ...
        logger.info(
            "Processing completed for video_id='%s' in %s seconds: thumbnail='%s'",
            video_id,
            elapsed,
            relative_thumbnail
        )
