...
import { BarChart3, CheckCircle2, Download, FileJson, FileText, Layers, Clock, Sparkles, ArrowLeft, Zap, ShieldCheck, TrendingUp, Target, Activity, FileCode2, User, Calendar, Check, } from "lucide-react";
...
export default function ReportPage() {
    ...
    return (_jsxs(motion.div, { variants: containerVariants, initial: "hidden", animate: "visible", className: "max-w-5xl mx-auto space-y-8 pb-16", children: [_jsxs(motion.div, { variants: itemVariants, className: "flex flex-col sm:flex-row sm:items-start justify-between gap-4", children: [_jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-xs font-semibold text-primary shadow-glow", children: [_jsx(BarChart3, { className: "w-3.5 h-3.5" }), _jsx("span", { children: "Patch Analytics Report" })] }), _jsx("h1", { className: "text-3xl md:text-4xl font-extrabold text-text tracking-tight", children: "Patch Report" }), _jsxs("p", { className: "text-muted text-sm", children: ["Full diff analysis for", " ", _jsx("span", { className: "text-text font-semibold", children: currentVideoTitle })] })] }), _jsxs("div", { className: "flex flex-wrap items-center gap-2.5 shrink-0", children: [_jsxs(motion.button, { whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, onClick: handleExportJSON, className: "inline-flex items-center gap-2 px-4 py-2.5 rounded-xl glass-card border border-amber-500/30 hover:border-amber-500/60 hover:bg-amber-500/10 text-muted hover:text-amber-400 font-medium text-sm transition-all", children: [jsonCopied ? (_jsx(Check, { className: "w-4 h-4 text-emerald-400" })) : (_jsx(FileJson, { className: "w-4 h-4 text-amber-400" })), _jsx("span", { children: jsonCopied ? "Downloaded!" : "Export JSON" })] }), _jsxs(motion.button, { whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, onClick: handleExportPDF, className: "inline-flex items-center gap-2 px-4 py-2.5 rounded-xl glass-card border border-rose-500/30 hover:border-rose-500/60 hover:bg-rose-500/10 text-muted hover:text-rose-400 font-medium text-sm transition-all", children: [_jsx(FileText, { className: "w-4 h-4 text-rose-400" }), "Export PDF"] }), _jsxs(motion.button, { whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, onClick: handleExportJSON, className: "inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-primary to-purple-600 hover:from-primary-hover hover:to-purple-700 text-white font-semibold text-sm shadow-glow transition-all", children: [_jsx(Download, { className: "w-4 h-4" }), "Download Report"] })] })] }), _jsx(motion.div, { variants: itemVariants, className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
                ...
                ].map(({ label, value, detail, icon: Icon, color }) => (_jsxs(motion.div, { whileHover: { y: -3 }, className: "glass-card rounded-2xl p-5 border border-border flex flex-col justify-between space-y-3 h-full group", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("span", { className: "text-xs font-semibold text-muted uppercase tracking-wider", children: label }), _jsx("div", { className: `w-9 h-9 rounded-xl border flex items-center justify-center transition-all group-hover:text-white ${color}`, children: _jsx(Icon, { className: "w-4.5 h-4.5" }) })] }), _jsxs("div", { children: [_jsx("p", { className: "text-2xl font-extrabold text-text tracking-tight", children: value }), _jsx("p", { className: "text-[11px] text-muted/80 mt-1", children: detail })] })] }, label))) }), _jsxs(motion.div, { variants: itemVariants, className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [_jsxs("div", { className: "glass-card rounded-2xl p-5 border border-border flex items-center gap-4", children: [_jsx("div", { className: "w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 shrink-0", children: _jsx(ShieldCheck, { className: "w-5 h-5" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-muted uppercase tracking-wider font-semibold", children: "Avg Confidence" }), _jsxs("p", { className: "text-2xl font-extrabold text-text", children: [avgConfidence, "%"] })] })] }), _jsxs("div", { className: "glass-card rounded-2xl p-5 border border-border flex items-center gap-4", children: [_jsx("div", { className: "w-10 h-10 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center text-primary shrink-0", children: _jsx(TrendingUp, { className: "w-5 h-5" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-muted uppercase tracking-wider font-semibold", children: "Hours Saved" }), _jsx("p", { className: "text-2xl font-extrabold text-text", children: "~1.5h" })] })] }), _jsxs("div", { className: "glass-card rounded-2xl p-5 border border-border flex items-center gap-4", children: [_jsx("div", { className: "w-10 h-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-400 shrink-0", children: _jsx(Zap, { className: "w-5 h-5" }) }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-muted uppercase tracking-wider font-semibold", children: "Version Created" }), _jsx("p", { className: "text-2xl font-extrabold text-primary font-mono", children: "v1.3" })] })] })] }), latestPatch && (_jsxs(motion.div, { variants: itemVariants, className: "glass-card rounded-2xl border border-primary/25 bg-gradient-to-r from-primary/10 via-surface to-card p-5 md:p-6 space-y-3 shadow-xl", children: [_jsxs("div", { className: "flex items-center gap-2 text-xs font-semibold text-primary uppercase tracking-wider", children: [_jsx(Sparkles, { className: "w-4 h-4" }), "Applied Patch Command"] }), _jsxs("div", { className: "font-mono text-xs md:text-sm bg-black/40 border border-white/10 px-4 py-3 rounded-xl text-text/90 break-all", children: ["\"", latestPatch.command, "\""] }), _jsxs("div", { className: "flex flex-wrap items-center gap-4 pt-1 text-xs text-muted", children: [_jsxs("span", { className: "flex items-center gap-1.5", children: [_jsx(FileCode2, { className: "w-3.5 h-3.5 text-primary" }), "Version: ", _jsx("span", { className: "text-text font-bold font-mono ml-1", children: latestPatch.version })] }), _jsxs("span", { className: "flex items-center gap-1.5", children: [_jsx(User, { className: "w-3.5 h-3.5 text-primary" }), "Author: ", _jsx("span", { className: "text-text font-semibold ml-1", children: latestPatch.author })] }), _jsxs("span", { className: "flex items-center gap-1.5", children: [_jsx(Calendar, { className: "w-3.5 h-3.5 text-primary" }), "Applied: ", _jsx("span", { className: "text-text font-semibold ml-1", children: latestPatch.date })] })] })] })), _jsxs(motion.div, { variants: itemVariants, className: "glass-card rounded-2xl border border-border overflow-hidden shadow-xl", children: [_jsxs("div", { className: "flex items-center justify-between px-6 py-4 border-b border-border bg-surface/50", children: [_jsxs("h2", { className: "text-base font-bold text-text flex items-center gap-2", children: [_jsx(BarChart3, { className: "w-4.5 h-4.5 text-primary" }), "Asset Breakdown Table"] }), _jsxs("span", { className: "text-xs text-muted font-mono bg-surface border border-border px-2.5 py-1 rounded-lg", children: [report.table.length, " assets"] })] }), _jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "w-full text-sm", children: [_jsx("thead", { children: _jsxs("tr", { className: "border-b border-border bg-card/40", children: [_jsx("th", { className: "text-left text-xs font-semibold uppercase tracking-wider text-muted px-5 py-3", children: "Asset" }), _jsx("th", { className: "text-left text-xs font-semibold uppercase tracking-wider text-muted px-5 py-3", children: "Format" }), _jsx("th", { className: "text-left text-xs font-semibold uppercase tracking-wider text-muted px-5 py-3", children: "Version" }), _jsx("th", { className: "text-left text-xs font-semibold uppercase tracking-wider text-muted px-5 py-3", children: "Status" }), _jsx("th", { className: "text-left text-xs font-semibold uppercase tracking-wider text-muted px-5 py-3", children: "Confidence" }), _jsx("th", { className: "text-right text-xs font-semibold uppercase tracking-wider text-muted px-5 py-3", children: "Changes" })] }) }), _jsx("tbody", { children: report.table.map((row, idx) => {
                                        const conf = row.confidence;
                                        const fmt = row.format;
                                        return (_jsxs(motion.tr, { initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { delay: idx * 0.06 }, className: "border-b border-border/50 hover:bg-white/[0.025] transition", children: [_jsx("td", { className: "px-5 py-4", children: _jsxs("div", { className: "flex items-center gap-2.5", children: [_jsx(FileText, { className: "w-4 h-4 text-muted shrink-0" }), _jsx("span", { className: "font-semibold text-text", children: row.asset })] }) }), _jsx("td", { className: "px-5 py-4", children: _jsxs("span", { className: "font-mono text-[11px] font-semibold bg-surface text-muted border border-border px-2 py-0.5 rounded", children: [".", fmt?.toLowerCase()] }) }), _jsx("td", { className: "px-5 py-4", children: _jsx("span", { className: "font-mono text-xs font-bold text-primary bg-primary/10 border border-primary/20 px-2 py-0.5 rounded", children: row.version }) }), _jsx("td", { className: "px-5 py-4", children: _jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20", children: [_jsx(CheckCircle2, { className: "w-3 h-3" }), row.status] }) }), _jsx("td", { className: "px-5 py-4", children: _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-20 h-1.5 rounded-full bg-surface overflow-hidden border border-border", children: _jsx("div", { className: "h-full bg-gradient-to-r from-primary to-emerald-400 rounded-full", style: { width: `${conf}%` } }) }), _jsxs("span", { className: "text-xs font-mono font-semibold text-emerald-400", children: [conf, "%"] })] }) }), _jsxs("td", { className: "px-5 py-4 text-right", children: [_jsx("span", { className: "text-text font-extrabold text-base", children: row.changes }), _jsx("span", { className: "text-muted ml-1 text-xs", children: "replacements" })] })] }, row.asset));
                                    }) }), _jsx("tfoot", { children: _jsxs("tr", { className: "bg-surface/60 border-t border-primary/20", children: [_jsx("td", { colSpan: 5, className: "px-5 py-3 text-xs font-bold text-muted uppercase tracking-wider", children: "Total Replacements" }), _jsxs("td", { className: "px-5 py-3 text-right", children: [_jsx("span", { className: "text-lg font-extrabold text-primary", children: totalOccurrences }), _jsx("span", { className: "text-muted ml-1 text-xs", children: "replacements" })] })] }) })] }) })] }), _jsxs(motion.div, { variants: itemVariants, className: "flex flex-wrap items-center gap-4 pt-4 border-t border-border/50", children: [_jsxs(Link, { to: "/history", className: "inline-flex items-center gap-2 px-5 py-2.5 rounded-xl glass-card border border-border text-muted hover:text-text hover:bg-white/10 font-medium text-sm transition", children: [_jsx(ArrowLeft, { className: "w-4 h-4" }), " Back to History"] }), _jsxs(Link, { to: "/create-patch", className: "inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-primary to-purple-600 hover:from-primary-hover hover:to-purple-700 text-white font-semibold text-sm shadow-glow transition-all", children: [_jsx(Sparkles, { className: "w-4 h-4" }), " Create Another Patch"] })] })] }));
}
