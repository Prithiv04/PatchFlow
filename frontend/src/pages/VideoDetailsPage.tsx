    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/create-patch"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-primary to-purple-600 hover:from-primary-hover hover:to-purple-700 text-white font-semibold text-xs shadow-glow transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Left 2 Cols: Video Player & Main Details */}
        ...
        {/* Right 1 Col: Applied Patches & Actions */}
        <div className="space-y-6">
          <div className="glass-card rounded-2xl p-6 border border-border space-y-4">
            ...
            <Link
              to="/create-patch"
              className="w-full py-2.5 rounded-xl bg-surface hover:bg-white/10 text-text text-xs font-semibold border border-border transition flex items-center justify-center gap-2"
            >
              <Plus className="w-4 h-4 text-primary" /> Add Another Patch
            </Link>
          </div>
        </div>
      </div>
